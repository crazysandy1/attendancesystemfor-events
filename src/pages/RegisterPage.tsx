      ...
      <div className="w-full max-w-md">
        <div className="rounded-xl border border-border bg-card p-8 shadow-lg">
          ...
          {!entryOpen ? (
            ...
            <div className="flex flex-col items-center gap-4 rounded-lg bg-success/10 p-8 text-center">
              ...
              <div>
                ...
                <p className="text-sm font-medium text-card-foreground mb-6">
                  Please be seated. Await the exit QR code at the end of the
                  session.
                </p>
              </div>
            </div>
